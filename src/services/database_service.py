...
class DatabaseService:
    ...
    def get_database_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for table in tables:
                count = self.execute_query(f"SELECT COUNT(*) as count FROM {table}", fetch_one=True)
            ...
            stats['database_version'] = version_info['config_value'] if version_info else 'unknown'
